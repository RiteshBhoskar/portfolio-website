...
export default function Intro(){
    return(
        <section>
            <div className="flex flex-col-reverse mt-15 sm:pt-10 sm:mb-4 w-full justify-between sm:h-lvh sm:flex-row scroll-mt-28"
            id="home">
                {/* left div  */}
                <div className=" h-fit sm:h-lvh w-full flex flex-col sm:w-[50%] font-lato px-5 mb-7 sm:mt-45 sm:pl-10 intro">
                    <div className="sm:pt-16">
                        ...
                        <div className="font-light text-7xl text-white">
                        Ritesh Bhoskar
                        </div>
                    </div>
                    ...
                    I have a deep passion for technology and computer science, enjoying every aspect from front-end design to backend problem-solving, and I also love working with hardware.
                    </div>
                    <div className="flex flex-col sm:flex-row gap-2 mt-3">
                        <Link href={"#contact"}
                            ...
                            <a href="" // ADD THE RESUME LINK HERE
                            download
                            ...
                            <a href="https://www.linkedin.com/in/ritesh-bhoskar"
                            target="_blank"
                            ...
                            <a href="https://github.com/RiteshBhoskar"
                            target="_blank"
                            rel="noopener noreferrer"
